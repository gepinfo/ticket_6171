...
import "./samplescreen.scss";

import  {service}  from './samplescreen.service';


class Samplescreen extends React.Component<any, any> {
    ...
    render(){
        return(
            <>
            <h2 className="screen-align">samplescreen</h2>
